    ...
    <View style={styles.container}>
      ...
      >
        <MapViewDirections
          ...
          strokeColor="#ff0000"
          apikey={"AIzaSyCfth-YSb3CNVnO8iUg1Y9V_lAGSkpadBg"}
          onReady={(result) => {
        ...
        >
          <View
            style={{ backgroundColor: "#ff0000", padding: 5, borderRadius: 20 }}
          >
        ...
        >
          <View
            style={{ backgroundColor: "#ff0000", padding: 5, borderRadius: 20 }}
          >
            <MaterialIcons name="liquor" size={30} color="white" />
          </View>
        </Marker>
      </MapView>
      ...
      >
        ...
        <View style={styles.deliveryDetailsContainer}>
          ...
          <View style={styles.orderDetailsContainer}>
            <Text style={styles.orderItemsText}>Jack Daniels 750ml x1</Text>
            <Text style={styles.orderItemsText}>Black Label 1ltr x3</Text>
            <Text style={styles.orderItemsText}>Guiness x2</Text>
            <Text style={styles.orderItemsText}>Coca-Cola x1</Text>
          </View>
        </View>
        <Pressable
          style={{
            ...styles.buttonContainer,
            backgroundColor: isButtonDisabled() ? "grey" : "#ff0000",
          }}
